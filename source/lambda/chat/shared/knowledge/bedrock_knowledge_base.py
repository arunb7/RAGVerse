...
class BedrockKnowledgeBase(KnowledgeBase):
    ...
    def __init__(
        ...
        # knowledge base id is extracted from the access token for isolation/multi-tenancy
        self.user_context_token = user_context_token
        try:
            token_payload = user_context_token.split(".")[1]
            token_payload_decoded = str(base64.b64decode(token_payload + "=="), "utf-8")
            json_payload = json.loads(token_payload_decoded)
